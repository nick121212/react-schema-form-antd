...
var SelectWidget = (function (_super) {
    ...
    SelectWidget.prototype.handleChange = function (value, item) {
        ...
        if (uiSchema.schema.type === "array" && uiSchema.schema.items.type === "number") {
    ...
    SelectWidget.prototype.render = function () {
        ...
        return (React.createElement(antd_1.Select, __assign({ disabled: uiSchema.readonly, placeholder: uiSchema.title, notFoundContent: loading ? React.createElement(antd_1.Spin, { size: "small" }) : null }, triggerProps, select, this.setDefaultProps()), options.renderOptions ? options.renderOptions(titleMap) : titleMap.map(function (val, i) {
