...
var SelectWidget = (function (_super) {
    ...
    SelectWidget.prototype.render = function () {
        ...
        return (React.createElement(antd_1.Select, __assign({ onChange: this.handleChange.bind(this), disabled: uiSchema.readonly, placeholder: uiSchema.title, notFoundContent: loading ? React.createElement(antd_1.Spin, { size: "small" }) : null }, select, triggerProps, this.setDefaultProps()), titleMap.map(function (val, i) {
            return React.createElement(antd_1.Select.Option, { value: val.value, title: val.label, key: val.value }, val.label);
        })));
    };
    return SelectWidget;
}(base_1.BaseWidget));
