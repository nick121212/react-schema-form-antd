...
var ObjectField = (function (_super) {
    ...
    ObjectField.prototype.render = function () {
        ...
        return (React.createElement(antd_1.Card, __assign({}, options.card, { style: { marginBottom: 10 }, title: React.createElement(antd_1.Row, { type: "flex", justify: "space-between" },
