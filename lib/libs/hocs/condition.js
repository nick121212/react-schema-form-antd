...
exports.ConditionHoc = function (Component) {
    return (function (_super) {
        ...
        Hoc.prototype.render = function () {
            var _a = this.getCurrentConditionKeys().initial, initial = _a === void 0 ? undefined : _a;
            var _b = (this.state || {}).condition, condition = _b === void 0 ? (initial !== undefined ? initial : true) : _b;
            if (!condition) {
