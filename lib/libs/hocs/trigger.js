...
exports.TriggerHoc = function (Component) {
    return (function (_super) {
        ...
        Hoc.prototype.handleTrigger = function (value) {
            ...
            var _g = uiSchema["ui:data"] || {}, _h = _g.path, path = _h === void 0 ? "" : _h, _j = _g.idField, idField = _j === void 0 ? "" : _j, _k = _g.labelField, labelField = _k === void 0 ? "" : _k, _l = _g.groupField, groupField = _l === void 0 ? "" : _l;
            if (always || (value != text && trigger)) {
                ...
                this.timeId = setTimeout(function () {
                    ...
                    trigger(value, schemaForm).then(function (dataSource) {
                        ...
                        formEvent.emit(["triggerEvent"].concat(keys), {
                            dataSource: utils_1.utils.getOptions(dataSource, idField, labelField, groupField),
                            loading: false
                        });
                    });
                }, 300);
