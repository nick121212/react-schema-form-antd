...
var Utils = (function () {
    ...
    Utils.prototype.getOptions = function (data, idField, labelField, groupField) {
        if (!idField) {
            return data;
        }
    ...
    Utils.prototype.getUiData = function (uiSchema, formData) {
        var _a = uiSchema["ui:data"] || {}, _b = _a.path, path = _b === void 0 ? "" : _b, _c = _a.idField, idField = _c === void 0 ? "" : _c, _d = _a.labelField, labelField = _d === void 0 ? "" : _d, _e = _a.groupField, groupField = _e === void 0 ? "" : _e;
        var currentData = {};
        if (!path || !idField) {
            return [];
        }
